...
**Design Decisions**: AWS Bedrock with Claude 3.5 Sonnet, structured prompts, temperature=0.7, AWS Translate for multilingual support
...
*For any* product sale with price P, the system should allocate exactly 0.85 × P to the artisan, 0.10 × P to the coordinator, and 0.05 × P to platform operations, such that artisan_share + coordinator_share + platform_share = P.
