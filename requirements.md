...
- **AI_Generator**: AWS Bedrock component for content generation using Claude 3.5 Sonnet for high-reasoning storytelling and lesson creation
...
3. WHEN a product is sold, THE Platform SHALL allocate 10% of the sale price to the coordinator
4. WHEN a product is sold, THE Platform SHALL allocate 5% of the sale price to platform operations
5. THE Platform SHALL display revenue distribution calculations to demonstrate fair pricing (MVP: mock payment for demo)
